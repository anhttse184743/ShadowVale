...
namespace ShadowVale.Map01.Editor
{
    public static partial class Map02VillageBuilder
    {
        ...
        {
            OptimizedMapBuilder.SourceData data;using(var f=File.OpenRead("SourceArt/Map02_Village/Botanical.meshdata.json.gz"))using(var z=new GZipStream(f,CompressionMode.Decompress))using(var r=new StreamReader(z))data=JsonUtility.FromJson<OptimizedMapBuilder.SourceData>(r.ReadToEnd());
