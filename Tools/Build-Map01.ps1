...
& $UnityEditor -batchmode -quit -projectPath $project -executeMethod ShadowVale.Map01.Editor.OptimizedMapBuilder.Build -logFile (Join-Path $logs 'Map01-build.log')
...
Write-Host 'Map 1 generated. Open Assets/_Project/Scenes/Maps/Map 1.unity.'
